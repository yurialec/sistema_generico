...
class PermissionSeeder extends Seeder
{
    public function run()
    {
        $permissions = [
            ...
            ['module_id' => 1, 'name' => 'users.update', 'label' => 'Editar Usuário'],
            ...
            ['module_id' => 1, 'name' => 'roles.update', 'label' => 'Editar Perfil'],
            ...
            ['module_id' => 1, 'name' => 'permissions.update', 'label' => 'Editar Permissão'],
            ...
            ['module_id' => 1, 'name' => 'menu.update', 'label' => 'Editar Menu'],
