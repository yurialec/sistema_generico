            ...
            <div class="card  mt-5">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('ecommerce.store') }}">
                        ...
                        <div class="row mb-3">
                            <label for="first_name" class="col-md-4 col-form-label text-md-end">{{ __('Nome') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="last_name" class="col-md-4 col-form-label text-md-end">{{ __('Sobrenome') }}</label>
